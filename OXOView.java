...
public class OXOView extends Application implements EventHandler<ActionEvent>
{
    ...
    public void drawBoard(OXOModel boardState)
    {
        ...
        // Outcomes declared when game finished //
        ...
        // Next turn
        else if (boardState.getCurrentPlayer() != null) messageLabel.setText("Player " +
                boardState.getCurrentPlayer().getPlayingLetter() + "'s turn");
    }
